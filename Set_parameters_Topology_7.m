% Defining and setting all the 65 global variables for Topology #7
%
% Topology #7 describes a network with M = 4 tiers and Q = 40 Fog nodes, 
...
%
M = 4; % Positive integer-valued number of tiers of the considered Fog 
       % platform. It must be L >= M
      
pertiernodes_vec = [27, 9, 3 ,1]; 
...
A_mtx = [zeros(1,27), 1, zeros(1,12); 
         zeros(1,27), 1, zeros(1,12); 
         zeros(1,27), 1, zeros(1,12); 
         zeros(1,28), 1, zeros(1,11);  % Fog topology#7;(k=3, M=4) tree topology
         zeros(1,28), 1, zeros(1,11); 
         zeros(1,28), 1, zeros(1,11); 
         zeros(1,29), 1, zeros(1,10); 
         zeros(1,29), 1, zeros(1,10); 
         zeros(1,29), 1, zeros(1,10); 
         zeros(1,30), 1, zeros(1,9); 
         zeros(1,30), 1, zeros(1,9); 
         zeros(1,30), 1, zeros(1,9); 
         zeros(1,31), 1, zeros(1,8); 
         zeros(1,31), 1, zeros(1,8); 
         zeros(1,31), 1, zeros(1,8); 
         zeros(1,32), 1, zeros(1,7); 
         zeros(1,32), 1, zeros(1,7); 
         zeros(1,32), 1, zeros(1,7); 
         zeros(1,33), 1, zeros(1,6); 
         zeros(1,33), 1, zeros(1,6); 
         zeros(1,33), 1, zeros(1,6); 
         zeros(1,34), 1, zeros(1,5); 
         zeros(1,34), 1, zeros(1,5); 
         zeros(1,34), 1, zeros(1,5); 
         zeros(1,35), 1, zeros(1,4); 
         zeros(1,35), 1, zeros(1,4); 
         zeros(1,35), 1, zeros(1,4); 
         zeros(1,36), 1, zeros(1,3); 
         zeros(1,36), 1, zeros(1,3); 
         zeros(1,36), 1, zeros(1,3); 
         zeros(1,37), 1, zeros(1,2); 
         zeros(1,37), 1, zeros(1,2); 
         zeros(1,37), 1, zeros(1,2); 
         zeros(1,38), 1, 0         ; 
         zeros(1,38), 1, 0         ; 
...
L2Tmapping_vec = [2, 2, 2, 3];%The best quasi-uniform mapping
% The alternative mappings: [3 2 2 2] and [2 3 2 2] are nearly optimal
