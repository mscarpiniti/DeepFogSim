% Defining and setting all the 65 global variables for Topology #4
%
% Topology #4 describes a network with M = 5 tiers and Q = 31 Fog nodes, 
...
A_mtx = [zeros(1,16), ones(1,8), zeros(1,7); 
         zeros(1,16), ones(1,8), zeros(1,7); 
         zeros(1,16), ones(1,8), zeros(1,7); 
         zeros(1,16), ones(1,8), zeros(1,7); 
         zeros(1,16), ones(1,8), zeros(1,7); 
         zeros(1,16), ones(1,8), zeros(1,7); 
         ...
         zeros(1,16), ones(1,8), zeros(1,7); 
         zeros(1,16), ones(1,8), zeros(1,7); 
         zeros(1,16), ones(1,8), zeros(1,7); % Fog topology#4 for comparisons       
         zeros(1,24), ones(1,4), zeros(1,3);       
         zeros(1,24), ones(1,4), zeros(1,3); 
         zeros(1,24), ones(1,4), zeros(1,3); 
         zeros(1,24), ones(1,4), zeros(1,3); 
         zeros(1,24), ones(1,4), zeros(1,3); 
...
L2Tmapping_vec = [4, 2, 1, 1, 1]; %Good mapping [4 2 1 1 1]
%[2 3 4];
...
a_max_backup = 1.0e-5;
% The BEST is 1.0e-5. A good range that guarantees stable behaviors is [4.0e-6 , 1.0e-5].
...
sensitivity = 9.7;
% The BEST is 9.7. A good range that guarantees stable behaviors is [3.5 , 9.7]. 
