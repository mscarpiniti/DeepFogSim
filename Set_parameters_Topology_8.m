% Defining and setting all the 65 global variables for Topology #8
%
% Topology #8 describes a network with M = 3 tiers and Q = 21 Fog nodes, 
...
A_mtx = [zeros(1,16), 1, zeros(1,4); 
         zeros(1,16), 1, zeros(1,4); 
         zeros(1,16), 1, zeros(1,4); 
         zeros(1,16), 1, zeros(1,4);  % Fog topology#8;(k=4, M=3) tree topology
