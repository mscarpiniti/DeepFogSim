% Defining and setting all the 65 global variables for Topology #3
%
% Topology #3 describes a network with M = 4 tiers and Q = 15 Fog nodes, 
...
A_mtx = [zeros(1,8), ones(1,4), zeros(1,3); 
         zeros(1,8), ones(1,4), zeros(1,3);                                                           
         zeros(1,8), ones(1,4), zeros(1,3);                                
         zeros(1,8), ones(1,4), zeros(1,3);                               
         zeros(1,8), ones(1,4), zeros(1,3);                                
         zeros(1,8), ones(1,4), zeros(1,3);                                
         zeros(1,8), ones(1,4), zeros(1,3);                               
         zeros(1,8), ones(1,4), zeros(1,3);% Fog topology#3; Inter-topology Comparisons                              
         zeros(1,12),ones(1,2),         0 ;                               
         zeros(1,12),ones(1,2),         0 ;                               
         zeros(1,12),ones(1,2),         0 ;                               
         zeros(1,12),ones(1,2),         0 ;                               
         zeros(1,14),                   1 ;            
...
% in the simulated Fog platform. Hence, A_mtx is the (QxQ) binary (e.g.,
...
% L2Tmapping_vec = [3, 3, 2, 1];
L2Tmapping_vec = [3, 2, 2, 2]; %Mapping migliore e piu simile a quello di topolgy#2
%[2 3 4];
...
% T_exit_vec = [0.30, 0.35, 0.35, 0.40];
...
% f_MAX_vec = 9e+6*ones(1, sum(pertiernodes_vec));
...
% ftilde_MAX_vec = 8e+6*ones(1, sum(pertiernodes_vec));
...
a_max_backup = 6.0e-6; %6.0e-6 is the BEST. (6.0e-6 - 6.0e-7) is a good range that guarantees stable behaviors.
...
%
sensitivity = 9.7;
%9.7 is the BEST.(9.7-10.7) is a good range that guarantees stable behaviors.
